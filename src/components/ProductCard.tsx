...
export default function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div 
      ...
      className="group relative bg-[#F2ECE2] p-1 sm:p-1.5 rounded-[1.25rem] shadow-[0_8px_24px_rgba(0,0,0,0.06)] hover:shadow-[0_12px_32px_rgba(0,0,0,0.12)] border border-[#E5DCD0] hover:border-[#C9A84C]/40 transition-all duration-500 cursor-pointer flex flex-col justify-between h-full"
    >
      <div>
        {/* Product Image Box - Maximized Micro-Framed Canvas */}
        <div className="relative overflow-hidden rounded-xl aspect-[4/5] bg-brand-cream select-none">
          <img
            src={product.image}
            alt={product.name}
          ...
          <button
            ...
            className="absolute top-2 right-2 w-8 h-8 grid place-items-center rounded-full shadow-sm bg-white/95 text-brand-heading hover:text-brand-accent cursor-pointer hover:scale-105 transition-all duration-300 z-10"
      ...
      <div className="px-1.5 pb-1.5 mt-1.5 flex items-center justify-between gap-2 select-none">
        {/* Price */}
